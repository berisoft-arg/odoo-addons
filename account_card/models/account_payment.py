...
# them by a m2o record
    ...
    voucher_card_id = fields.Many2one(
        'res.card',
        'Card',
        readonly=True,
        copy=False,
...
# on change methods
    ...
    def onchange_partner_voucher(self):
        ...
        if self.payment_method_code == 'received_third_voucher':
            self.voucher_card_id = (
                commercial_partner.card_ids and
                commercial_partner.card_ids[0].card_id or False)
            ...
            self.voucher_card_id = self.journal_id.card_id
...
# post methods
    ...
    def X_create(self,vals):
        ...
        if payment_method and payment_method.code == 'received_third_voucher':
            ...
            for rec in res:
                ...
                res.create_voucher(voucher_type,None,card)
        return res

    def create_voucher(self, voucher_type, operation, card):
        self.ensure_one()
        ...
        * from _get_liquidity_move_line_vals to add voucher operation and, if
        ...
        if (
            ...
            voucher = self.create_voucher(
                    'third_voucher', operation, self.voucher_card_id)
            if not vals:
                vals = {}
            ...
            operation = 'handed'
            voucher = self.create_voucher(
                'issue_voucher', operation, self.voucher_card_id)
            vals['date_maturity'] = self.voucher_payment_date
            ...
            self.create_voucher('issue_voucher', 'withdrawed', self.voucher_card_id)
    ...
    def do_print_vouchers(self):
        ...
        # si todos los vouchers son de la misma chequera entonces buscamos
